    ...
    private List<Security> loadSecurityData(){
        ...
        try{
            ...
            if(line != null){
                ...
                if(cusipCtr == -1 || priceCtr == -1 || maturityDateCtr == -1 || spRatingCtr == -1 || sectorCtr == -1){
            ...
            while(line != null){
                ...
                sec.secRating = alloc.Rating.valueOf(sec.spRating).getQIndex() < 6? SecRating.ABOVE_A: SecRating.A_OR_BELOW;
